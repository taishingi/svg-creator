...
mod tests {
    ...
    pub fn all() {
        let f = "flags";
        let d = "distros";
        assert!(Svg::new(900, 600, Some("0 0 900 600".to_string()))
            .start()
        ...
        assert!(Svg::new(900, 600, Some("0 0 90000 60000".to_string()))
            .start()
        ...
        assert!(Svg::new(900, 600, Some("0 0 27 18".to_string()))
            .start()
        ...
        assert!(Svg::new(512, 512, Some("0 0 512 512".to_string()))
            .start()
        ...
        assert!(Svg::new(267, 267, None)
            .start()
            .path("#294172","M 266.62575,133.50613 C 266.62575,59.98128 207.02222,0.37583 133.49792,0.37583 C 60.00668,0.37583 0.42639,59.93123 0.37425,133.41225 L 0.37425,236.4333 C 0.4138,253.11763 13.94545,266.62417 30.64027,266.62417 L 133.55192,266.62417 C 207.05167,266.59532 266.62575,207.01142 266.62575,133.50613",None,None,Some("voice".to_string()))
            .path("#294172","M 77.126289,142.09756 C 77.126289,142.09756 124.97104,142.09756 124.97104,142.09756 C 124.97104,142.09756 124.97104,189.94234 124.97104,189.94234 C 124.97104,216.35263 103.53659,237.78707 77.126289,237.78707 C 50.715979,237.78707 29.28153,216.35263 29.28153,189.94234 C 29.28153,163.53203 50.715979,142.09756 77.126289,142.09756 z",Some("#3c6eb4".to_string()),Some(23.21),Some("in".to_string()))
            .uses("finity","matrix(-1,0,0,-1,249.71151,284.2882)",Some("in".to_string()))
            .path("#ffffff","M 139.6074,127.52923 L 139.6074,189.87541 C 139.6074,224.37943 111.63203,252.35541 77.12679,252.35541 C 71.89185,252.35541 68.1703,251.7644 63.32444,250.49771 C 56.25849,248.64859 50.48398,242.85518 50.48158,236.1166 C 50.48158,227.97147 56.39394,222.0467 65.23187,222.0467 C 69.43824,222.0467 70.96454,222.85435 77.12679,222.85435 C 95.3184,222.85435 110.07443,208.11916 110.10634,189.92756 L 110.10634,161.27099 C 110.10634,158.70324 108.01971,156.62274 105.44767,156.62274 L 83.78246,156.61846 C 75.71034,156.61846 69.18845,150.18003 69.18845,142.0858 C 69.18414,133.94124 75.77725,127.52923 83.93653,127.52923",None,None,Some("free".to_string()))
            .uses("dom","matrix(-1,0,0,-1,249.71152,284.28821)",Some("free".to_string()))
            .path("#3c6eb4","M 243.65456,243.58425 C 243.65456,243.58425 243.6546,238.05286 243.6546,238.05286 L 241.12607,243.85062 C 241.12607,243.85062 238.66466,238.05286 238.66466,238.05286 L 238.66513,243.58425 L 237.24683,243.58425 L 237.24683,234.84933 L 238.73387,234.84933 C 238.73387,234.84933 241.16784,240.42984 241.16784,240.42984 L 243.56495,234.84933 L 245.07039,234.84933 L 245.07039,243.58425 L 243.65456,243.58425 z M 233.32154,236.31241 L 233.32154,243.58425 L 231.83941,243.58425 L 231.83941,236.31241 L 229.35453,236.31241 L 229.35453,234.84933 L 235.80399,234.84933 L 235.80399,236.31241",None,None,Some("TM".to_string()))
            .end()
            .save(d, "fedora")
            .is_ok());
    }
